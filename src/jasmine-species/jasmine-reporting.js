...
(function(jasmine) {
    ...
    /**
     * The StyledHtmlReporter augments the jasmine.TrivialReporter
     *
     ...
     */
    var StyledHtmlReporter = function(doc) {
        this.document = doc || document;
        this.suiteDivs = {};
        this.logRunningSpecs = false;
    };

    StyledHtmlReporter.prototype = new jasmine.TrivialReporter();
    StyledHtmlReporter.prototype.constructor = StyledHtmlReporter;


    StyledHtmlReporter.prototype.reportRunnerStarting = function(runner) {
    ...
    StyledHtmlReporter.prototype.reportSuiteResults = function(suite) {
    ...
    StyledHtmlReporter.prototype.reportSpecResults = function(spec) {
     ...
     */
    StyledHtmlReporter.prototype.createDomFromListOrString = function(data, tags) {
        var classAttrs = '';
     ...
     */
    StyledHtmlReporter.prototype.createDomFromSuiteDefs = function(defs) {
        var classAttrs = '';
     ...
     */
    StyledHtmlReporter.prototype.createDomList = function(type, attrs, items) {
        var list;
    ...
    // ==== exports ====
    jasmine.reporting = { StyledHtmlReporter: StyledHtmlReporter };
